...
//                orderPay();
                break;
            case R.id.logistics:
                intent.setClass(MyOrderDetailActivity.this, LogisticsDetailActivity.class);
...
//                    }
//                    if (TextUtils.isEmpty(result.getData().getConsignee())) {
//                        mSelectAddress.setVisibility(View.GONE);
//                        mDeliveryStyle.setVisibility(View.GONE);
//                        mView.setVisibility(View.GONE);
//                        mPhoneNum.setVisibility(View.VISIBLE);
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(MyOrderDetailActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        intent.setClass(MyOrderDetailActivity.this, PayResultActivity.class);
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(MyOrderDetailActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(MyOrderDetailActivity.this, "您还未安装支付宝客户端", Toast.LENGTH_SHORT).show();
                        } else if (TextUtils.equals(resultStatus, "6001")) {
                            Toast.makeText(MyOrderDetailActivity.this, "您取消了支付,请重新支付!", Toast.LENGTH_SHORT).show();
                        }
