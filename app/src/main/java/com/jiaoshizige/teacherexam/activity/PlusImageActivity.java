...
import com.jiaoshizige.teacherexam.adapter.SelectViewPagerAdapter;
...
public class PlusImageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgList = getIntent().getStringArrayListExtra(MainContent.IMG_LIST);
        mPosition = getIntent().getIntExtra(MainContent.POSITION, 0);
        initView();
    }
    ...
    private void initView() {
        ...
        mAdapter = new SelectViewPagerAdapter(this, imgList);
    ...
    private void back() {
        ...
        intent.putStringArrayListExtra(MainContent.IMG_LIST, imgList);
        setResult(MainContent.RESULT_CODE_VIEW_IMG, intent);
        finish();
    }
