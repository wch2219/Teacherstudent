...
public class ZhenTiTestResultSheetActivity extends BaseActivity {
    ...
    private List<TestResultDetailResponse.mData> mDataList;
    private List<TestResultDetailResponse.mData> list1;
    private List<TestResultDetailResponse.mData> list2;
    private List<TestResultDetailResponse.mData> list3;
    private List<TestResultDetailResponse.mData> list4;
    private List<TestResultDetailResponse.mData> list5;
    private List<TestResultDetailResponse.mData> list6;
    private List<TestResultDetailResponse.mData> list8;
    private List<TestResultDetailResponse.mData> list9;
...
//            Log.d("************aa----", TimeUtils.formatTimes(aa)+"------------");
        ...
        mDataList = (List<TestResultDetailResponse.mData>) getIntent().getSerializableExtra("data");
        ...
        if (mDataList.size() > 0 && mDataList != null) {
            ...
            if (list1.size() > 0) {
                ...
                mSingleRecycleView1.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list1) {
                    ...
                    protected void convert(ViewHolderZhy holder, TestResultDetailResponse.mData item, final int position) {
                        ...
                        holder.setOnClickListener(R.id.topic_number, new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                //设置返回数据
                                ZhenTiTestResultSheetActivity.this.setResult(RESULT_OK, intent);
                                //关闭Activity
            ...
            if (list2.size() > 0) {
                ...
                mShortRecycleView2.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list2) {
            ...
            if (list3.size() > 0) {
                ...
                mAnalysisRecycleView3.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list3) {
            ...
            if (list4.size() > 0) {
                ...
                mEssayRecycleView4.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list4) {
            ...
            if (list5.size() > 0) {
                ...
                mWriteRecycleView5.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list5) {
            ...
            if (list6.size() > 0) {
                ...
                mMaterialRecycl6.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list6) {
            ...
            if (list8.size() > 0) {
                ...
                mTeachRecycleView8.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list8) {
            ...
            if (list9.size() > 0) {
                ...
                mActivityRecycleView9.setAdapter(new CommRecyclerViewAdapter<TestResultDetailResponse.mData>(mContext, R.layout.item_sheet_layout, list9) {
        ...
        Xutil.GET(ApiUrl.ZHENTIPOST, map, new MyCallBack<TestResultResponse>() {
            ...
            public void onSuccess(TestResultResponse result) {
                ...
                if (result.getStatus_code().equals("200")) {
                    ...
                    Intent intent = new Intent();
                    intent.setClass(ZhenTiTestResultSheetActivity.this, ZhenTiTestResultActivity.class);
