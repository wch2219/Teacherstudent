...
import com.jiaoshizige.teacherexam.zz.adapter.StartZhemTiPracticeAdapter;
...
public class StartZhenTiPracticeFragment extends MBaseFragment {
    @BindView(R.id.title)
    WebView mTitle;
    ...
    private ZhenTiResponse.mData mData;
    private StartZhenTiPracticaActivity mActivity;
    private StartZhemTiPracticeAdapter mAdapter;
    ...
    public StartZhenTiPracticeFragment(StartZhenTiPracticaActivity startPracticaActivity, ZhenTiResponse.mData mData, int i, String size) {
    ...
    public StartZhenTiPracticeFragment() {
    }
    ...
    protected void onInitViews(Bundle savedInstanceState) {
        ...
        if (mData != null) {
            ...
            if (mData.getType().equals("1")) {
                ...
                mAdapter = new StartZhemTiPracticeAdapter(getActivity());
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            if (size.equals(String.valueOf(tag + 1))) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        final StartZhenTiPracticaActivity mainActivity = (StartZhenTiPracticaActivity) getActivity();
                                        mainActivity.setFragmentSkipInterface(new StartZhenTiPracticaActivity.FragmentSkipInterface() {
                                            @Override
