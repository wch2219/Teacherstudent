...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        try {
            TableUtils.createTable(connectionSource, ZhenTiList.class);
            TableUtils.createTable(connectionSource, ZhenTi.class);
            TableUtils.createTable(connectionSource, QuestionBankList.class);
            TableUtils.createTable(connectionSource, UserAnswer.class);
    ...
    public void onUpgrade(SQLiteDatabase database, ConnectionSource connectionSource, int oldVersion, int newVersion) {
        try {
            TableUtils.dropTable(connectionSource, ZhenTiList.class, true);
            TableUtils.dropTable(connectionSource, ZhenTi.class, true);
            TableUtils.dropTable(connectionSource, QuestionBankList.class, true);
            TableUtils.dropTable(connectionSource, UserAnswer.class, true);
