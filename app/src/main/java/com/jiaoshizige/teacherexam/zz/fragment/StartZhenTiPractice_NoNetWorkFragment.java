...
import com.jiaoshizige.teacherexam.zz.adapter.StartZhemTiPractice_NoNetWorkAdapter;
...
public class StartZhenTiPractice_NoNetWorkFragment extends MBaseFragment {
    @BindView(R.id.title)
    WebView mTitle;
    ...
    private StartZhenTiPractica_NoNetworkActivity mActivity;
    private StartZhemTiPractice_NoNetWorkAdapter mAdapter;
    ...
    public StartZhenTiPractice_NoNetWorkFragment(StartZhenTiPractica_NoNetworkActivity startPracticaActivity, ZhenTi mData, int i, String size) {
    ...
    public StartZhenTiPractice_NoNetWorkFragment() {
    }
    ...
    protected void onInitViews(Bundle savedInstanceState) {
        ...
        if (mData != null) {
            ...
            if (mData.getType() == 1) {//选择题
                mListView.setVisibility(View.VISIBLE);
                mButton.setVisibility(View.GONE);
                mSubjective.setVisibility(View.GONE);
                mAdapter = new StartZhemTiPractice_NoNetWorkAdapter(getActivity());
                mListView.setAdapter(mAdapter);
                List<ZhenTiResponse.mMetas> dataBeans = JSON.parseArray(mData.getMetas(), ZhenTiResponse.mMetas.class);
                mAdapter.setmList(dataBeans);
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            if (size.equals(String.valueOf(tag + 1))) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        final StartZhenTiPractica_NoNetworkActivity mainActivity = (StartZhenTiPractica_NoNetworkActivity) getActivity();
                                        mainActivity.setFragmentSkipInterface(new StartZhenTiPractica_NoNetworkActivity.FragmentSkipInterface() {
                                            @Override
