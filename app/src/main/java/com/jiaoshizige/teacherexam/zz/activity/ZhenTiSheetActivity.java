...
public class ZhenTiSheetActivity extends BaseActivity {
    ...
    private List<ZhenTiResponse.mData> list1;
    private List<ZhenTiResponse.mData> list2;
    private List<ZhenTiResponse.mData> list3;
    private List<ZhenTiResponse.mData> list4;
    private List<ZhenTiResponse.mData> list5;
    private List<ZhenTiResponse.mData> list6;
    private List<ZhenTiResponse.mData> list8;
    private List<ZhenTiResponse.mData> list9;
...
//            Log.d("************aa----", TimeUtils.formatTimes(aa)+"------------");
        ...
        mDataList = (List<ZhenTiResponse.mData>) getIntent().getSerializableExtra("data");
        ...
        if (mDataList.size() > 0 && mDataList != null) {
            ...
            if (list1.size() > 0) {
                ...
                mSingleRecycleView1.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list1) {

                    @Override
                    protected void convert(ViewHolderZhy holder, ZhenTiResponse.mData item, final int position) {
                        ...
                        holder.setOnClickListener(R.id.topic_number, new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                //设置返回数据
                                ZhenTiSheetActivity.this.setResult(RESULT_OK, intent);
                                //关闭Activity
                                ZhenTiSheetActivity.this.finish();
                            }
                        });
                    }
                });
            ...
            if (list2.size() > 0) {
                ...
                mShortRecycleView2.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list2) {
            ...
            if (list3.size() > 0) {
                ...
                mAnalysisRecycleView3.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list3) {
            ...
            if (list4.size() > 0) {
                ...
                mEssayRecycleView4.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list4) {
            ...
            if (list5.size() > 0) {
                ...
                mWriteRecycleView5.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list5) {
            ...
            if (list6.size() > 0) {
                ...
                mMaterialRecycl6.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list6) {
            ...
            if (list8.size() > 0) {
                ...
                mTeachRecycleView8.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list8) {
            ...
            if (list9.size() > 0) {
                ...
                mActivityRecycleView9.setAdapter(new CommRecyclerViewAdapter<ZhenTiResponse.mData>(mContext, R.layout.item_sheet_layout, list9) {
        ...
        Xutil.GET(ApiUrl.ZHENTIPOST, map, new MyCallBack<TestResultResponse>() {
            ...
            public void onSuccess(TestResultResponse result) {
                ...
                if (result.getStatus_code().equals("200")) {
                    ...
                    Intent intent = new Intent();
                    intent.setClass(ZhenTiSheetActivity.this, ZhenTiTestResultActivity.class);
