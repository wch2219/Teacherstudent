...
public class CustomProgressDialog1 extends Dialog {
	  private Context context = null;  
	    ...
	    public static CustomProgressDialog1 createDialog(Context context){
	        customProgressDialog = new CustomProgressDialog1(context, R.style.CustomProgressDialog);
	     ...
	     * 
	     */  
	    public CustomProgressDialog1 setTitile(String strTitle){
	        return customProgressDialog;  
	    }  
	     ...
	     * 
	     */  
	    public CustomProgressDialog1 setMessage(String strMessage){
