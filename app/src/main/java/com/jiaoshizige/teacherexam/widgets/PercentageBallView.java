...
//		mCirclePaint.setColor(Color.WHITE);
		mCirclePaint.setColor(Color.rgb(219, 219, 219));
...
//		mCirclePaint.setStrokeWidth(mCircleSTROKEWidth);
		...
		mWavePaint.setColor(Color.rgb(153,127,222));
//		mWavePaint.setColor(Color.RED);
	...
	protected void onDraw(Canvas canvas) {
		// TODO Auto-generated method stub
		super.onDraw(canvas);
		canvas.drawCircle(mScreenWidth / 2, mScreenHeight / 2, mScreenWidth / 4+ mRingSTROKEWidth / 2 -3, mCirclePaint);
		//  得到控件的宽高
		int width = getWidth();
		int height = getHeight();
//		setBackgroundColor(Color.RED);// 可以自定义色值
		setBackgroundColor(Color.rgb(246, 243, 254));// 可以自定义色值
		// 计算当前油量线和水平中线的距离
