...
public class SDViewUtil
{
    ...
    {
        return MyApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    {
        hideInputMethod(view, MyApplication.getContext());
    }
    ...
    {
        showInputMethod(view, MyApplication.getContext(), 0);
    }

    public static void showInputMethod(View view, long delay)
    {
        showInputMethod(view, MyApplication.getContext(), delay);
    }
        ...
        if (listOriginalData != null)
        {
            ...
            } else
            {
                if (!isLoadMore)
                {
                    ...
                    {
                        ToastUtil.showShortToast(noData);
                    }
                    listOriginalData.clear();
                } else
                {
                    ...
                    {
                        ToastUtil.showShortToast(noMoreData);
                    }
                }
            }
        }
    ...
    {
        LinearLayout linAll = new LinearLayout(MyApplication.getContext());
