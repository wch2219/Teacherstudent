...
public class ADTextView extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mSpeed = array.getInt(R.styleable.ADTextView_ad_text_view_speed, 2);
        ...
        mFrontTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_front_size, ToolUtils.Sp2Px(getContext(), 14));
        mContentTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_content_size, ToolUtils.Sp2Px(getContext(), 12));
        array.recycle();
    }
