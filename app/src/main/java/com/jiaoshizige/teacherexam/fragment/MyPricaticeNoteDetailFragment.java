...
import com.jiaoshizige.teacherexam.activity.MyPracticeNoteDetailActivity;
...
import com.jiaoshizige.teacherexam.adapter.MyPracticeNoteDetailAdapter;
...
public class MyPricaticeNoteDetailFragment extends MBaseFragment {
    @BindView(R.id.title)
    WebView mTitle;
    ...
    public MyPricaticeNoteDetailFragment(MyPracticeNoteDetailActivity recruitProblemActivity, PracticeRecordsResponse.mData mData) {
    ...
    protected void onInitViews(Bundle savedInstanceState) {
        ...
        if (mData != null) {
            ...
            mAdapter = new MyPracticeNoteDetailAdapter(getActivity(), mData.getAnswer(), mData.getUser_answer());
