...
public class PopupwindowAdapter extends BaseAdapter {
    ...
    public PopupwindowAdapter(Context context, List<NoteaWorkChapterResponse.mData> mDatas,AllPopupwindow popupwindow,String flag) {
        this.mFlag = flag;
        this.mDatas = mDatas;
       this.mContext=context;
        mInflater = LayoutInflater.from(context);
        this.allPopupwindow = popupwindow;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (states.get(String.valueOf(position)) == null || states.get(String.valueOf(position)) == false) {
            ...
            viewHolder.mRadioButton.setTextColor(ContextCompat.getColor(mContext,R.color.text_color3));
        } else {
            res = true;
            viewHolder.mRadioButton.setTextColor(ContextCompat.getColor(mContext,R.color.purple4));
        }
