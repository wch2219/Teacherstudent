...
public class RecordDetailAdapter extends MBaseAdapter<RecordDetailResponse.mMetas> {
    ...
    public RecordDetailAdapter(Context context, String answer, String user_answer) {
        super(context);
        this.answer = answer;
