...
public class MyQuestionBankCollectionAdapter extends MBaseAdapter<MyQuestionBankCollectionResponse.mMetas> {
    private String[] letter = {"A", "B", "C", "D"};
    public MyQuestionBankCollectionAdapter(Context context) {
        super(context);
    }
