...
public class MyPracticeNoteDetailAdapter extends MBaseAdapter<PracticeRecordsResponse.mMetas> {
    private String answer;
    private String user_answer;
    private String[] letter = {"A", "B", "C", "D"};

    public MyPracticeNoteDetailAdapter(Context context) {
        super(context);
    }

    public MyPracticeNoteDetailAdapter(Context context, String answer, String user_answer) {
        super(context);
        this.answer = answer;
