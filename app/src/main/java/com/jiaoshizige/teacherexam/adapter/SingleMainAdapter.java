 ...
 */
public class SingleMainAdapter extends BaseExpandableListAdapter {
    private Context mContext;
    private NewCourseCatalogResponse.mCourseList mData;
    ViewHolder holder = null;
    public SingleMainAdapter(Context context, NewCourseCatalogResponse.mCourseList data){
    ...
    public NewCourseCatalogResponse.mCatalog getChild(int parentPosition, int childPosition) {
        return mData.getCatalog().get(childPosition);
    }
    ...
    public View getChildView(final int parentPosition, final int childPosition, boolean isExpanded, View view, ViewGroup viewGroup) {
        ...
        childData.add(bean);
        SingleChildAdapter adapter = new SingleChildAdapter(mContext,mData,childData,parentPosition,childListView);
