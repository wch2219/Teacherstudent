...
import com.jiaoshizige.teacherexam.activity.AddAddressActivity;
...
public class AddressListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private CommRecyclerViewAdapter<SelectAddressRespomse.mData> mAdapter;
...
//                        });
     ...
     * 删除地址
     */
    private void delAddress(final SelectAddressRespomse.mData data) {
...
//        map.put("user_id", 1);
     ...
     * 设置默认收货地址
     */
    private void defaultAdress(final SelectAddressRespomse.mData data){
        Map<String,Object> map=new HashMap<>();
//        map.put("user_id",1);
        map.put("user_id", (String) SPUtils.getSpValues(SPKeyValuesUtils.SP_USER_ID, SPUtils.TYPE_STRING));
        map.put("id",data.getId());
    ...
    private CommRecyclerViewAdapter<SelectAddressRespomse.mData> getAdapter() {
        if (null == mAdapter) {
            mAdapter = new CommRecyclerViewAdapter<SelectAddressRespomse.mData>(this, R.layout.item_address_list_layout, null) {
                @Override
                protected void convert(ViewHolderZhy holder, final SelectAddressRespomse.mData mData, final int position) {
                    holder.setText(R.id.address_name, mData.getName());
                    holder.setText(R.id.address_phone, mData.getMobile());
                    holder.setText(R.id.address_site, mData.getProvince() + mData.getCity() + mData.getCounty());
                    mCheckBox = (CheckBox) holder.getConvertView().findViewById(R.id.checkbox_address);
