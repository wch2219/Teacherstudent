...
//                mCourseNoData.setVisibility(View.GONE);
    ...
    private CommRecyclerViewAdapter<QuestionAnswerReponse.mData> getAdapter() {
        if (null == mAdapter) {
            mAdapter = new CommRecyclerViewAdapter<QuestionAnswerReponse.mData>(getActivity(), R.layout.item_question_answer, null) {
                @Override
                protected void convert(ViewHolderZhy holder, final QuestionAnswerReponse.mData mData,int position) {
                    holder.setText(R.id.question,mData.getContent());
                    holder.setText(R.id.sanwer,mData.getAnswer().getContent());
                    holder.setText(R.id.sanwer_num,mData.getCount()+"人回复");
                    holder.setText(R.id.question_time,mData.getCreated_at());
                    final Intent intent = new Intent();
                    intent.setClass(getActivity(),QuestionDetialActivity.class);
                    holder.setOnClickListener(R.id.all_item, new View.OnClickListener() {
            ...
            mQuestionAnswerList.setLayoutManager(new LinearLayoutManager(getActivity()));
            mQuestionAnswerList.setAdapter(mAdapter);
        }
        return mAdapter;
    }
}
